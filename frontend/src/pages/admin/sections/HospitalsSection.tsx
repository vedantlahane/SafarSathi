        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Emergency Ready</div>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-bold">{availBeds}/{totalBeds}</div>
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">With Ambulance</div>
            </div>
          </CardContent>
        </Card>
      </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {h.tier && (
                        <Badge variant="secondary" className="text-[10px] capitalize">{h.tier}</Badge>
                      )}
                    </div>
                  ...
                  <div className="flex gap-1 ml-2">
                    ...
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-red-500" onClick={() => onDelete(h)}>
