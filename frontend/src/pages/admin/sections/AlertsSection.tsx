    ...
    <div className="min-h-full flex flex-col">
      ...
      <div className="px-6 py-5 glass-bar border-b border-white/30">
        <div className="flex items-center justify-between mb-2">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-800">Alert Management</h2>
            <p className="text-sm font-medium text-slate-500 mt-1">Monitor and respond to system alerts</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2.5 px-3.5 py-2 glass-thin bg-red-500/10 rounded-xl border border-red-500/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
              ...
              <span className="text-sm font-bold text-red-700 tracking-wide">{activeCount} Active</span>
            </div>
            <div className="flex items-center gap-2.5 px-3.5 py-2 glass-thin bg-amber-500/10 rounded-xl border border-amber-500/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
              <div className="w-2.5 h-2.5 rounded-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]" />
              <span className="text-sm font-bold text-amber-700 tracking-wide">{pendingCount} Pending</span>
            </div>
          </div>
        </div>
      </div>
