    ...
    <div className="min-h-full flex flex-col">
      ...
      <div className="glass-bar px-6 py-5 border-b border-white/30">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-800">Risk Zone Management</h2>
            <p className="text-sm font-medium text-slate-500 mt-1">Define and manage geofenced risk areas</p>
          </div>
          ...
          <CardHeader className="py-3 px-5 border-b border-white/20 glass-bar">
            <CardTitle className="text-[13px] uppercase tracking-wider flex items-center gap-2 font-bold text-slate-500">
              <div className="relative">
                ...
                {isAddingZone && <span className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-blue-500 rounded-full animate-pulse shadow-[0_0_8px_rgba(59,130,246,0.6)]" />}
              </div>
          ...
          <CardHeader className="py-3 px-5 border-b border-white/20 glass-bar">
            <CardTitle className="text-[13px] uppercase tracking-wider flex items-center justify-between font-bold text-slate-500">
              ...
              <Button
                ...
                className={`rounded-xl h-8 px-3 text-[11px] font-bold tracking-wide transition-all ${isAddingZone ? "bg-red-500/10 text-red-600 hover:bg-red-500/20" : "bg-blue-500/10 text-blue-600 hover:bg-blue-500/20"}`}
              >
                {isAddingZone ? "Cancel" : <><Plus className="w-3.5 h-3.5 mr-1.5" /> New</>}
              </Button>
            </CardTitle>
          </CardHeader>
