...
export async function seedDatabase() {
  const policeCount = await PoliceDepartmentModel.countDocuments();
  if (policeCount > 0) {
    console.log("📦 Database already seeded, skipping...");
    return;
  }

  console.log("🌱 Seeding database with Punjab data...");
  ...
  // Seed demo tourist
  const existingTourist = await TouristModel.findById("ca4b21f2-ce17-49ef-a829-57d063d20163");
  if (!existingTourist) {
    await createTourist({
  ...
  // ── Seed Punjab Risk Zones ──
  await RiskZoneModel.insertMany([
    {
      zoneId: 1,
      name: "Wagah Border Security Zone",
      description: "High security military zone near Pakistan border. Civilians must stay on designated paths.",
      centerLat: 31.6045,
      centerLng: 74.5729,
      radiusMeters: 1500,
      riskLevel: "HIGH",
    ...
    {
      zoneId: 2,
      name: "Sutlej River Flood Plain",
      description: "Flood-prone low-lying area along the Sutlej river. Avoid during monsoon season.",
      centerLat: 30.8500,
      centerLng: 75.9200,
      radiusMeters: 2000,
      riskLevel: "MEDIUM",
    ...
    },
    {
      ...
      description: "Dense industrial zone with heavy traffic and air quality concerns.",
      centerLat: 30.8900,
      centerLng: 75.8400,
      radiusMeters: 1000,
      riskLevel: "LOW",
  ...
  // ── Seed Punjab Police Stations ──
  await PoliceDepartmentModel.insertMany([
    {
      _id: randomUUID(),
      name: "YatraX Punjab Control Center",
      email: "admin@YatraX.in",
      passwordHash: await hashPassword("admin123"),
      departmentCode: "YX-CONTROL",
      latitude: 30.9010,
      longitude: 75.8573,
      city: "Ludhiana",
      district: "Ludhiana",
    ...
    {
      _id: randomUUID(),
      name: "Ludhiana Division Police HQ",
      email: "ldh.hq@punjabpolice.gov.in",
      passwordHash: await hashPassword("admin123"),
      departmentCode: "PS-LDH-HQ",
      latitude: 30.9098,
      longitude: 75.8573,
      city: "Ludhiana",
      district: "Ludhiana",
      state: "Punjab",
      contactNumber: "+91-161-2440999",
      isActive: true,
      stationType: "district_hq",
    ...
    {
      _id: randomUUID(),
      name: "Amritsar City Police Station",
      email: "asr.city@punjabpolice.gov.in",
      passwordHash: await hashPassword("admin123"),
      departmentCode: "PS-ASR-CITY",
      latitude: 31.6340,
      longitude: 74.8723,
      city: "Amritsar",
      district: "Amritsar",
      state: "Punjab",
      contactNumber: "+91-183-2541112",
      isActive: true,
      stationType: "station",
    ...
    {
      _id: randomUUID(),
      name: "Jalandhar Cantonment Police Post",
      email: "jal.cantt@punjabpolice.gov.in",
      passwordHash: await hashPassword("admin123"),
      departmentCode: "PP-JAL-CANTT",
      latitude: 31.3260,
      longitude: 75.5762,
      city: "Jalandhar",
      district: "Jalandhar",
      state: "Punjab",
      contactNumber: "+91-181-2225345",
      isActive: true,
      stationType: "outpost",
    ...
    {
      _id: randomUUID(),
      name: "Phagwara Police Station",
      email: "phagwara@punjabpolice.gov.in",
      passwordHash: await hashPassword("admin123"),
    ...
    {
      _id: randomUUID(),
      name: "Patiala Kotwali Police Station",
      email: "patiala.kotwali@punjabpolice.gov.in",
      passwordHash: await hashPassword("admin123"),
      departmentCode: "PS-PTL-KOTWALI",
      latitude: 30.3398,
      longitude: 76.3869,
      city: "Patiala",
      district: "Patiala",
      state: "Punjab",
      contactNumber: "+91-175-2212345",
      isActive: true,
      stationType: "station",
      jurisdictionRadiusKm: 18,
      officerCount: 14,
    },
  ]);

  // ── Seed Punjab Hospitals ──
  await HospitalModel.insertMany([
    ...
    {
      hospitalId: 3,
      name: "Sri Guru Ram Dass Jee International Airport Hospital",
      latitude: 31.7096,
      longitude: 74.7973,
      contact: "+91-183-2592000",
      type: "clinic",
      emergency: true,
      city: "Amritsar",
      district: "Amritsar",
    ...
    {
      hospitalId: 4,
      name: "Fortis Hospital Amritsar",
      latitude: 31.6340,
      longitude: 74.8600,
      contact: "+91-183-5050001",
      type: "hospital",
      emergency: true,
      city: "Amritsar",
      district: "Amritsar",
  ...
  // Initialize counters
  await CounterModel.findByIdAndUpdate("riskZoneId", { seq: 3 }, { upsert: true });
  ...
  await CounterModel.findByIdAndUpdate("hospitalId", { seq: 6 }, { upsert: true });
  ...
  console.log("✅ Punjab database seeded successfully");
}
